...
{
    public unsafe partial class CResNCS : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nNCSNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pNCSData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNCSC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNCSC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNCS13GetNCSDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetNCSDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNCS10GetNCSSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetNCSSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNCS8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResNCS __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResNCS(native.ToPointer(), skipVTables);
        }

        internal static new CResNCS __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResNCS)managed;
        ...
        internal static new CResNCS __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResNCS)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResNCS __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResNCS(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResNCS.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResNCS(__Internal native, bool skipVTables = false)
        ...
        protected CResNCS(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResNCS()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNCS.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResNCS");
        }

        public CResNCS(global::NWN.LowLevel.CResNCS _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNCS.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNNCSNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nNCSNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nNCSNormalSize = value;
            }
        }

        public byte* MPNCSData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pNCSData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pNCSData = (__IntPtr) value;
            }
        }

        public byte* NCSDataPtr
        {
            get
            {
                var __ret = __Internal.GetNCSDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint NCSSize
        {
            get
            {
                var __ret = __Internal.GetNCSSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResNCS.__GetInstance(__instance);
