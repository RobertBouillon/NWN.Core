...
{
    public unsafe partial class CResTLK : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResTLKC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResTLKC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);
        }

        internal static new CResTLK __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResTLK(native.ToPointer(), skipVTables);
        }

        internal static new CResTLK __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResTLK)managed;
        ...
        internal static new CResTLK __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResTLK)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResTLK __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResTLK(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResTLK.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResTLK(__Internal native, bool skipVTables = false)
        ...
        protected CResTLK(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResTLK()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResTLK.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResTLK");
        }

        public CResTLK(global::NWN.LowLevel.CResTLK _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResTLK.__Internal));
            __ownsNativeInstance = true;
        ...
        {
            var __target = global::NWN.LowLevel.CResTLK.__GetInstance(__instance);
