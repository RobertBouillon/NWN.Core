...
{
    public unsafe partial class CResIFO : global::NWN.LowLevel.CResGFF, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResIFOC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResIFOC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);
        }

        internal static new CResIFO __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResIFO(native.ToPointer(), skipVTables);
        }

        internal static new CResIFO __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResIFO)managed;
        ...
        internal static new CResIFO __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResIFO)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResIFO __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResIFO(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResIFO.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResIFO(__Internal native, bool skipVTables = false)
        ...
        protected CResIFO(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResIFO(global::NWN.LowLevel.CResIFO _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResIFO.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            ...
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResIFO");
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResIFO.__GetInstance(__instance);
