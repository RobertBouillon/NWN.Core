...
{
    public unsafe partial class CNWSWaypoint : global::NWN.LowLevel.CNWSObject, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(784)]
            internal int m_bMapNote;

            [FieldOffset(788)]
            internal int m_bMapNoteEnabled;

            [FieldOffset(792)]
            internal global::NWN.LowLevel.CExoLocString.__Internal m_szMapNote;

            [FieldOffset(808)]
            internal global::NWN.LowLevel.CExoLocString.__Internal m_sLocalizedName;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypointC2Ej", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance, uint oidId);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypointC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypoint9AddToAreaEP8CNWSAreafffi", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void AddToArea(__IntPtr __instance, __IntPtr pArea, float fX, float fY, float fZ, int bRunScripts);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypoint14RemoveFromAreaEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void RemoveFromArea(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypoint16LoadFromTemplateE7CResRefP10CExoString", CallingConvention = __CallingConvention.Cdecl)]
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypoint12LoadWaypointEP7CResGFFP10CResStructP10CExoString", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int LoadWaypoint(__IntPtr __instance, __IntPtr pRes, __IntPtr cWaypointStruct, __IntPtr pTag);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN12CNWSWaypoint12SaveWaypointEP7CResGFFP10CResStruct", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int SaveWaypoint(__IntPtr __instance, __IntPtr pRes, __IntPtr cWaypointStruct);
        }

        internal static new CNWSWaypoint __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CNWSWaypoint(native.ToPointer(), skipVTables);
        }

        internal static new CNWSWaypoint __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CNWSWaypoint)managed;
        ...
        internal static new CNWSWaypoint __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CNWSWaypoint)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CNWSWaypoint __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CNWSWaypoint(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CNWSWaypoint.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CNWSWaypoint(__Internal native, bool skipVTables = false)
        ...
        protected CNWSWaypoint(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CNWSWaypoint(uint oidId)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSWaypoint.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance, oidId);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CNWSWaypoint");
        }

        public CNWSWaypoint(global::NWN.LowLevel.CNWSWaypoint _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSWaypoint.__Internal));
            __ownsNativeInstance = true;
        ...
        public int LoadWaypoint(global::NWN.LowLevel.CResGFF pRes, global::NWN.LowLevel.CResStruct cWaypointStruct, global::NWN.LowLevel.CExoString pTag)
        {
            var __arg0 = pRes is null ? __IntPtr.Zero : pRes.__Instance;
            var __arg1 = cWaypointStruct is null ? __IntPtr.Zero : cWaypointStruct.__Instance;
            var __arg2 = pTag is null ? __IntPtr.Zero : pTag.__Instance;
            var __ret = __Internal.LoadWaypoint(__Instance, __arg0, __arg1, __arg2);
            return __ret;
        }

        public int SaveWaypoint(global::NWN.LowLevel.CResGFF pRes, global::NWN.LowLevel.CResStruct cWaypointStruct)
        {
            var __arg0 = pRes is null ? __IntPtr.Zero : pRes.__Instance;
            var __arg1 = cWaypointStruct is null ? __IntPtr.Zero : cWaypointStruct.__Instance;
            var __ret = __Internal.SaveWaypoint(__Instance, __arg0, __arg1);
            return __ret;
        }

        public static implicit operator global::NWN.LowLevel.CNWSWaypoint(uint oidId)
        {
            return new global::NWN.LowLevel.CNWSWaypoint(oidId);
        }

        public int MBMapNote
        {
            get
            {
                return ((__Internal*)__Instance)->m_bMapNote;
            }

            set
            {
                ((__Internal*)__Instance)->m_bMapNote = value;
            }
        }

        public int MBMapNoteEnabled
        {
            get
            {
                return ((__Internal*)__Instance)->m_bMapNoteEnabled;
            }

            set
            {
                ((__Internal*)__Instance)->m_bMapNoteEnabled = value;
            }
        }

        public global::NWN.LowLevel.CExoLocString MSzMapNote
        {
            get
            {
                return global::NWN.LowLevel.CExoLocString.__CreateInstance(new __IntPtr(&((__Internal*)__Instance)->m_szMapNote));
            }
            ...
            set
            {
                ...
                ((__Internal*)__Instance)->m_szMapNote = *(global::NWN.LowLevel.CExoLocString.__Internal*) value.__Instance;
            }
        }
        ...
        public override global::NWN.LowLevel.CNWSWaypoint AsNWSWaypoint
        {
            get
            {
                return base.AsNWSWaypoint;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CNWSWaypoint.__GetInstance(__instance);
