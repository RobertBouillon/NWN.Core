...
{
    public unsafe partial class CNWSPortal : global::NWN.LowLevel.CNWSObject, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortalC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortalC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortal4LoadEP7CResGFFP10CResStruct", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int Load(__IntPtr __instance, __IntPtr pRes, __IntPtr pSoundStruct);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortal4SaveEP7CResGFFP10CResStruct", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void Save(__IntPtr __instance, __IntPtr pRes, __IntPtr pStruct);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortal9AddToAreaEP8CNWSArea", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void AddToArea(__IntPtr __instance, __IntPtr pArea);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortal14RemoveFromAreaEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void RemoveFromArea(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN10CNWSPortal15PackIntoMessageEP11CNWSMessage", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void PackIntoMessage(__IntPtr __instance, __IntPtr pMessage);
        }

        internal static new CNWSPortal __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CNWSPortal(native.ToPointer(), skipVTables);
        }

        internal static new CNWSPortal __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CNWSPortal)managed;
        ...
        internal static new CNWSPortal __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CNWSPortal)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CNWSPortal __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CNWSPortal(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CNWSPortal.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CNWSPortal(__Internal native, bool skipVTables = false)
        ...
        protected CNWSPortal(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CNWSPortal()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSPortal.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CNWSPortal");
        }

        public CNWSPortal(global::NWN.LowLevel.CNWSPortal _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSPortal.__Internal));
            __ownsNativeInstance = true;
        ...
        public int Load(global::NWN.LowLevel.CResGFF pRes, global::NWN.LowLevel.CResStruct pSoundStruct)
        {
        ...
        public void AddToArea(global::NWN.LowLevel.CNWSArea pArea)
        {
            var __arg0 = pArea is null ? __IntPtr.Zero : pArea.__Instance;
            __Internal.AddToArea(__Instance, __arg0);
        }
        ...
        public virtual global::NWN.LowLevel.CNWSPortal AsNWSPortal
        {
            get
            {
                var ___AsNWSPortalDelegate = __VTables.GetMethodDelegate<global::NWN.LowLevel.Delegates.Func___IntPtr___IntPtr>(0, 61);
                var __ret = ___AsNWSPortalDelegate(__Instance);
                var __result0 = global::NWN.LowLevel.CNWSPortal.__GetOrCreateInstance(__ret, true);
                return __result0;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CNWSPortal.__GetInstance(__instance);
        ...
        // CNWSPortal * AsNWSPortal()
        private static global::NWN.LowLevel.Delegates.Func___IntPtr___IntPtr _AsNWSPortalDelegateInstance;

        private static __IntPtr _AsNWSPortalDelegateHook(__IntPtr __instance)
        {
            var __target = global::NWN.LowLevel.CNWSPortal.__GetInstance(__instance);
            var __ret = __target.AsNWSPortal;
            return __ret is null ? __IntPtr.Zero : __ret.__Instance;
        }
        ...
        internal static new class VTableLoader
        {
            ...
            private static readonly IntPtr[] Thunks = new IntPtr[61];
            ...
            static VTableLoader()
            {
                ...
                _AsNWSPortalDelegateInstance += _AsNWSPortalDelegateHook;
                ...
                Thunks[60] = Marshal.GetFunctionPointerForDelegate(_AsNWSPortalDelegateInstance);
            }
                ...
                if (!initialized)
                {
                    lock (ManagedVTables)
                    {
                        if (!initialized)
                        {
                            ...
                            ManagedVTablesDtorOnly[0] = CppSharp.Runtime.VTables.CloneTable(SafeHandles, instance, 0, 64);
                            ManagedVTablesDtorOnly[0][1] = Thunks[0];
                            ManagedVTables[0] = CppSharp.Runtime.VTables.CloneTable(SafeHandles, instance, 0, 64);
                            ...
                            ManagedVTables[0][61] = Thunks[60];
                            VTables.Methods[0] = new Delegate[64];
                        }
                    }
                }
