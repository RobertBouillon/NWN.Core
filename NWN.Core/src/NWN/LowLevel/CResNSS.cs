...
{
    public unsafe partial class CResNSS : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nNSSNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pNSSData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNSSC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNSSC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNSS13GetNSSDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetNSSDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNSS10GetNSSSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetNSSSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNSS8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResNSS __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResNSS(native.ToPointer(), skipVTables);
        }

        internal static new CResNSS __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResNSS)managed;
        ...
        internal static new CResNSS __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResNSS)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResNSS __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResNSS(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResNSS.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResNSS(__Internal native, bool skipVTables = false)
        ...
        protected CResNSS(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResNSS()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNSS.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResNSS");
        }

        public CResNSS(global::NWN.LowLevel.CResNSS _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNSS.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNNSSNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nNSSNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nNSSNormalSize = value;
            }
        }

        public byte* MPNSSData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pNSSData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pNSSData = (__IntPtr) value;
            }
        }

        public byte* NSSDataPtr
        {
            get
            {
                var __ret = __Internal.GetNSSDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint NSSSize
        {
            get
            {
                var __ret = __Internal.GetNSSSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResNSS.__GetInstance(__instance);
