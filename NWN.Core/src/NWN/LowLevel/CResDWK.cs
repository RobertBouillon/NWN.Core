...
{
    public unsafe partial class CResDWK : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nDWKNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pDWKData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResDWKC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResDWKC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResDWK13GetDWKDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetDWKDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResDWK10GetDWKSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetDWKSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResDWK8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResDWK __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResDWK(native.ToPointer(), skipVTables);
        }

        internal static new CResDWK __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResDWK)managed;
        ...
        internal static new CResDWK __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResDWK)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResDWK __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResDWK(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResDWK.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResDWK(__Internal native, bool skipVTables = false)
        ...
        protected CResDWK(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResDWK()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResDWK.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResDWK");
        }

        public CResDWK(global::NWN.LowLevel.CResDWK _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResDWK.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNDWKNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nDWKNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nDWKNormalSize = value;
            }
        }

        public byte* MPDWKData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pDWKData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pDWKData = (__IntPtr) value;
            }
        }

        public byte* DWKDataPtr
        {
            get
            {
                var __ret = __Internal.GetDWKDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint DWKSize
        {
            get
            {
                var __ret = __Internal.GetDWKSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResDWK.__GetInstance(__instance);
