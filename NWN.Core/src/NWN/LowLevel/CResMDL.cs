...
{
    public unsafe partial class CResMDL : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nMDLNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pMDLData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResMDLC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResMDLC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResMDL13GetMDLDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetMDLDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResMDL10GetMDLSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetMDLSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResMDL8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResMDL __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResMDL(native.ToPointer(), skipVTables);
        }

        internal static new CResMDL __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResMDL)managed;
        ...
        internal static new CResMDL __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResMDL)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResMDL __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResMDL(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResMDL.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResMDL(__Internal native, bool skipVTables = false)
        ...
        protected CResMDL(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResMDL()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResMDL.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResMDL");
        }

        public CResMDL(global::NWN.LowLevel.CResMDL _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResMDL.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNMDLNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nMDLNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nMDLNormalSize = value;
            }
        }

        public byte* MPMDLData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pMDLData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pMDLData = (__IntPtr) value;
            }
        }

        public byte* MDLDataPtr
        {
            get
            {
                var __ret = __Internal.GetMDLDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint MDLSize
        {
            get
            {
                var __ret = __Internal.GetMDLSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResMDL.__GetInstance(__instance);
