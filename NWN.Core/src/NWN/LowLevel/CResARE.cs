...
{
    public unsafe partial class CResARE : global::NWN.LowLevel.CResGFF, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResAREC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResAREC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);
        }

        internal static new CResARE __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResARE(native.ToPointer(), skipVTables);
        }

        internal static new CResARE __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResARE)managed;
        ...
        internal static new CResARE __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResARE)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResARE __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResARE(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResARE.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResARE(__Internal native, bool skipVTables = false)
        ...
        protected CResARE(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResARE(global::NWN.LowLevel.CResARE _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResARE.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            ...
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResARE");
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResARE.__GetInstance(__instance);
