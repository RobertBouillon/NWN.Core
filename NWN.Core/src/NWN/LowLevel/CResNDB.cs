...
{
    public unsafe partial class CResNDB : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nNDBNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pNDBData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNDBC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNDBC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNDB13GetNDBDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetNDBDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNDB10GetNDBSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetNDBSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResNDB8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResNDB __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResNDB(native.ToPointer(), skipVTables);
        }

        internal static new CResNDB __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResNDB)managed;
        ...
        internal static new CResNDB __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResNDB)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResNDB __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResNDB(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResNDB.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResNDB(__Internal native, bool skipVTables = false)
        ...
        protected CResNDB(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResNDB()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNDB.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResNDB");
        }

        public CResNDB(global::NWN.LowLevel.CResNDB _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResNDB.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNNDBNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nNDBNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nNDBNormalSize = value;
            }
        }

        public byte* MPNDBData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pNDBData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pNDBData = (__IntPtr) value;
            }
        }

        public byte* NDBDataPtr
        {
            get
            {
                var __ret = __Internal.GetNDBDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint NDBSize
        {
            get
            {
                var __ret = __Internal.GetNDBSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResNDB.__GetInstance(__instance);
