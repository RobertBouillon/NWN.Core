...
{
    public unsafe partial class CNWSRules : global::NWN.LowLevel.CNWRules, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN9CNWSRulesC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN9CNWSRulesC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);
        }

        internal static new CNWSRules __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CNWSRules(native.ToPointer(), skipVTables);
        }

        internal static new CNWSRules __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CNWSRules)managed;
        ...
        internal static new CNWSRules __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CNWSRules)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CNWSRules __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CNWSRules(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CNWSRules.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CNWSRules(__Internal native, bool skipVTables = false)
        ...
        protected CNWSRules(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CNWSRules()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSRules.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CNWSRules");
        }

        public CNWSRules(global::NWN.LowLevel.CNWSRules _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CNWSRules.__Internal));
            __ownsNativeInstance = true;
        ...
        {
            var __target = global::NWN.LowLevel.CNWSRules.__GetInstance(__instance);
