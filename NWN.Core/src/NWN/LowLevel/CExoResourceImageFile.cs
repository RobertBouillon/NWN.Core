...
{
    public unsafe partial class CExoResourceImageFile : global::NWN.LowLevel.CExoPackedFile, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(72)]
            internal __IntPtr m_pResourceImage;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFileC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFileC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFile15GetKeyListEntryEj", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void GetKeyListEntry(__IntPtr @return, __IntPtr __instance, uint nIndex);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFile20GetResourceListEntryE5RESID", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern __IntPtr GetResourceListEntry(__IntPtr __instance, global::NWN.LowLevel.RESID.__Internal nID);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFile10GetKeyListEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern __IntPtr GetKeyList(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN21CExoResourceImageFile9GetHeaderEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern __IntPtr GetHeader(__IntPtr __instance);
        }

        internal static new CExoResourceImageFile __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CExoResourceImageFile(native.ToPointer(), skipVTables);
        }

        internal static new CExoResourceImageFile __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CExoResourceImageFile)managed;
        ...
        internal static new CExoResourceImageFile __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CExoResourceImageFile)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CExoResourceImageFile __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CExoResourceImageFile(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CExoResourceImageFile.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CExoResourceImageFile(__Internal native, bool skipVTables = false)
        ...
        protected CExoResourceImageFile(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CExoResourceImageFile()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CExoResourceImageFile.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CExoResourceImageFile");
        }

        public CExoResourceImageFile(global::NWN.LowLevel.CExoResourceImageFile _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CExoResourceImageFile.__Internal));
            __ownsNativeInstance = true;
        ...
        public virtual __IntPtr GetResource(global::NWN.LowLevel.RESID nID)
        {
            var ___GetResourceDelegate = __VTables.GetMethodDelegate<global::NWN.LowLevel.Delegates.Func___IntPtr___IntPtr_NWN_LowLevel_RESID___Internal>(0, 19);
            ...
            var __ret = ___GetResourceDelegate(__Instance, *(global::NWN.LowLevel.RESID.__Internal*) __arg0);
            return __ret;
        }

        public global::NWN.LowLevel.ENCAPSULATED_KEYLISTENTRY GetKeyListEntry(uint nIndex)
        {
            var __ret = new global::NWN.LowLevel.ENCAPSULATED_KEYLISTENTRY.__Internal();
            __Internal.GetKeyListEntry(new IntPtr(&__ret), __Instance, nIndex);
            return global::NWN.LowLevel.ENCAPSULATED_KEYLISTENTRY.__CreateInstance(__ret);
        }

        public global::NWN.LowLevel.ENCAPSULATED_RESLISTENTRY GetResourceListEntry(global::NWN.LowLevel.RESID nID)
        {
            if (ReferenceEquals(nID, null))
                throw new global::System.ArgumentNullException("nID", "Cannot be null because it is passed by value.");
            var __arg0 = nID.__Instance;
            var __ret = __Internal.GetResourceListEntry(__Instance, *(global::NWN.LowLevel.RESID.__Internal*) __arg0);
            var __result0 = global::NWN.LowLevel.ENCAPSULATED_RESLISTENTRY.__GetOrCreateInstance(__ret, false);
            return __result0;
        }

        public byte* MPResourceImage
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pResourceImage;
            }

            set
            {
                ((__Internal*)__Instance)->m_pResourceImage = (__IntPtr) value;
            }
        }

        public global::NWN.LowLevel.ENCAPSULATED_KEYLISTENTRY KeyList
        {
            get
            {
                var __ret = __Internal.GetKeyList(__Instance);
                __IntPtr ____ret = __ret == __IntPtr.Zero ? __IntPtr.Zero : new __IntPtr(*(void**) __ret);
                var __result0 = global::NWN.LowLevel.ENCAPSULATED_KEYLISTENTRY.__GetOrCreateInstance(____ret, false);
                return __result0;
            }
        }

        public global::NWN.LowLevel.ENCAPSULATED_HEADER Header
        {
            get
            {
                var __ret = __Internal.GetHeader(__Instance);
                var __result0 = global::NWN.LowLevel.ENCAPSULATED_HEADER.__GetOrCreateInstance(__ret, false);
                return __result0;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CExoResourceImageFile.__GetInstance(__instance);
        ...
        // void * GetResource(RESID nID)
        private static global::NWN.LowLevel.Delegates.Func___IntPtr___IntPtr_NWN_LowLevel_RESID___Internal _GetResourceDelegateInstance;

        private static __IntPtr _GetResourceDelegateHook(__IntPtr __instance, global::NWN.LowLevel.RESID.__Internal nID)
        {
            var __target = global::NWN.LowLevel.CExoResourceImageFile.__GetInstance(__instance);
            var __ret = __target.GetResource(global::NWN.LowLevel.RESID.__CreateInstance(nID));
            return __ret;
        }
        ...
        internal static new class VTableLoader
        {
            ...
            static VTableLoader()
            {
                ...
                _GetResourceDelegateInstance += _GetResourceDelegateHook;
                ...
                Thunks[18] = Marshal.GetFunctionPointerForDelegate(_GetResourceDelegateInstance);
            }
                ...
                if (!initialized)
                {
                    lock (ManagedVTables)
                    {
                        if (!initialized)
                        {
                            ...
                            ManagedVTablesDtorOnly[0] = CppSharp.Runtime.VTables.CloneTable(SafeHandles, instance, 0, 22);
                            ManagedVTablesDtorOnly[0][1] = Thunks[0];
                            ManagedVTables[0] = CppSharp.Runtime.VTables.CloneTable(SafeHandles, instance, 0, 22);
                            ...
                            VTables.Methods[0] = new Delegate[22];
                        }
                    }
                }
