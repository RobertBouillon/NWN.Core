...
{
    public unsafe partial class CResWOK : global::NWN.LowLevel.CRes, IDisposable
    {
        ...
        public new partial struct __Internal
        {
            ...
            [FieldOffset(80)]
            internal uint m_nWOKNormalSize;

            [FieldOffset(88)]
            internal __IntPtr m_pWOKData;

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResWOKC2Ev", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void ctor(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResWOKC2ERKS_", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern void cctor(__IntPtr __instance, __IntPtr _0);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResWOK13GetWOKDataPtrEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern byte* GetWOKDataPtr(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResWOK10GetWOKSizeEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern uint GetWOKSize(__IntPtr __instance);

            [SuppressUnmanagedCodeSecurity, DllImport("NWNXLib", EntryPoint = "_ZN7CResWOK8IsLoadedEv", CallingConvention = __CallingConvention.Cdecl)]
            internal static extern int IsLoaded(__IntPtr __instance);
        }

        internal static new CResWOK __CreateInstance(__IntPtr native, bool skipVTables = false)
        {
            return new CResWOK(native.ToPointer(), skipVTables);
        }

        internal static new CResWOK __GetOrCreateInstance(__IntPtr native, bool saveInstance = false, bool skipVTables = false)
        {
            if (native == __IntPtr.Zero)
                return null;
            if (NativeToManagedMap.TryGetValue(native, out var managed))
                return (CResWOK)managed;
        ...
        internal static new CResWOK __GetInstance(__IntPtr native)
        {
            if (!NativeToManagedMap.TryGetValue(native, out var managed))
                throw new System.Exception("No managed instance was found");
            var result = (CResWOK)managed;
            if (result.__ownsNativeInstance)
                result.SetupVTables();
            return result;
        }

        internal static CResWOK __CreateInstance(__Internal native, bool skipVTables = false)
        {
            return new CResWOK(native, skipVTables);
        }

        private static void* __CopyValue(__Internal native)
        {
            var ret = Marshal.AllocHGlobal(sizeof(__Internal));
            global::NWN.LowLevel.CResWOK.__Internal.cctor(ret, new __IntPtr(&native));
            return ret.ToPointer();
        }

        private CResWOK(__Internal native, bool skipVTables = false)
        ...
        protected CResWOK(void* native, bool skipVTables = false)
            : base((void*) native)
        {
            if (native == null)
                return;
        ...
        public CResWOK()
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResWOK.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            __Internal.ctor(__Instance);
            SetupVTables(GetType().FullName == "NWN.LowLevel.CResWOK");
        }

        public CResWOK(global::NWN.LowLevel.CResWOK _0)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::NWN.LowLevel.CResWOK.__Internal));
            __ownsNativeInstance = true;
        ...
        public uint MNWOKNormalSize
        {
            get
            {
                return ((__Internal*)__Instance)->m_nWOKNormalSize;
            }

            set
            {
                ((__Internal*)__Instance)->m_nWOKNormalSize = value;
            }
        }

        public byte* MPWOKData
        {
            get
            {
                return (byte*) ((__Internal*)__Instance)->m_pWOKData;
            }

            set
            {
                ((__Internal*)__Instance)->m_pWOKData = (__IntPtr) value;
            }
        }

        public byte* WOKDataPtr
        {
            get
            {
                var __ret = __Internal.GetWOKDataPtr(__Instance);
                return __ret;
            }
        }
        ...
        public uint WOKSize
        {
            get
            {
                var __ret = __Internal.GetWOKSize(__Instance);
                return __ret;
            }
        }
        ...
        {
            var __target = global::NWN.LowLevel.CResWOK.__GetInstance(__instance);
